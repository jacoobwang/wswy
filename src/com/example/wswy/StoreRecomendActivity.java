...
public class StoreRecomendActivity extends WsyBaseActivity implements OnItemClickListener,OnRefreshListener{
	...
	public void setLeftButton(){
		...
		leftBtn.setOnClickListener(new OnClickListener() {		
			...
			public void onClick(View arg0) {
				StoreRecomendActivity.this.finish();
			}
		});
	}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		intent.setClass(StoreRecomendActivity.this, StoreDetailActivity.class);
	...
	class LocalListHolderView extends ViewHolderModel{
		...
		public void SetViewHolerValues(Object aItemObject) { 
			...
			imProductPhoto.setTag(info.mProImg);
